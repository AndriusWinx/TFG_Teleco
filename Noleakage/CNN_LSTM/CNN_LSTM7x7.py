...
#n_samples, look_back, width, height, channels
...
myCNNLSTM.add(TimeDistributed(Conv2D(filters=num_filters, kernel_size=(3,3), padding='same', activation='relu'),
                              batch_input_shape=(batch_size, look_back, 7, 7, 1)))
...
filename = f'resultados_norandom3_CNN7x7LSTM_F{num_filters}_LB{look_back}_BS{batch_size}_EU{n_epochs_update}_T{error_threshold}_E{n_epochs}_GWOL'
