...
El Capítulo \ref{cap2:arte} refleja el trabajo realizado hasta ahora en el que es posible continuar la investigación introduciendo los modelos propuestos en \cite{tfgalicia} con \textit{online learning} sobre las celdas estudiadas en este TFG. Así sería posible evaluar su rendimiento sobre las mismas celdas eliminando las sospechas de sesgo planteadas anteriormente.
