...
Aun así, aunque las arquitecturas con más capas y, por ende, más capacidad de procesamiento sean menos susceptibles a cambios en los hiperparámetros, la aquitectura con una única capa convolucional (CNN+LSTM) es la que ha conseguido el mejor modelo.
