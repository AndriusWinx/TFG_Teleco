...
\subsection{Número de celdas, capas CNN y tamaño del \textit{kernel}}
...
\subsection{\texttt{look\_back} y \texttt{batch\_size}}
...
\subsection{\texttt{updates} y \texttt{threshold}}
...
\begin{figure}[h!]
	...
	\end{subfigure}
	\caption{Tráfico real y predicciones con \textit{online y \textit{offline learning}} del mejor modelo en las celdas 5162 (arriba) y 5163 (abajo). Elaboración propia.}
	\label{fig:bestcells}
\end{figure}
\FloatBarrier
...
\begin{figure}[h!]
	...
	\end{subfigure}
	\begin{subfigure}{\linewidth}
		\includesvg[inkscapelatex=false,scale=0.5]{Celdas/cell_plot_5357.svg}
	\end{subfigure}
	\caption{Tráfico real y predicciones con \textit{online y \textit{offline learning}} del mejor modelo en las celdas 4959 (arriba) y 5357 (abajo). Elaboración propia.}
	\label{fig:worstcells}
\end{figure}
\FloatBarrier
