...
\subsubsection{Unstable Gradients}
...
La última parte de las neuronas LSTM es la puerta de salida o \textit{output gate}. Ésta es controlada de la misma forma que las puertas descritas anteriormente e indica qué porción del nuevo vector de largo alcance $c_t$ es considerado como salida $\hat{y}_t$ y nuevo vector de corto alcance $h_t$.
