...
\begin{equation}
	\mathbf{B}_k = 
	\begin{bmatrix}
		\mathbf{G}_k     & \mathbf{G}_{k+1}   & \dots  & \mathbf{G}_{k+LB-1} \\
		\mathbf{G}_{k+1} & \mathbf{G}_{k+2}   & \dots  & \mathbf{G}_{k+LB}   \\
		\vdots           & \vdots             & \ddots & \vdots               \\
		\mathbf{G}_{k+BS-1} & \mathbf{G}_{k+BS} & \dots  & \mathbf{G}_{k+BS+LB-2}
	\end{bmatrix} 
...
\begin{equation}
	\textbf{Y}_k = \textbf{X}_{k+BS+LB-1}
\end{equation}
