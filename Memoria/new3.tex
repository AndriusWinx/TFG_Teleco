...
\begin{align}
	\label{eq1} z=b+\sum_{j=1}^{J}w_j\cdot&x_j = \textbf{w}^T\textbf{x} + b\\
	\label{eq2} y=\phi&(z)
\end{align}
...
\begin{equation}
	\hat{y_t} = \phi(\textbf{W}_x^T \textbf{x}_t + b + w_{\hat{y}}\cdot\hat{y}_{t-1})
	\label{eq11}
\end{equation}
...
\begin{equation}
	\hat{\textbf{y}}_t = \phi(\textbf{W}_x^T \textbf{x}_t + \textbf{W}_{\hat{y}}^T \hat{\textbf{y}}_{t-1} + \textbf{b})
\end{equation}
...
\subsubsection{Minibatch con las series temporales}
